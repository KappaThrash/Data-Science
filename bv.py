...
fig2 = px.histogram(df_bookprice_filtered['book price'])

col1, col2 = st.columns(2)
col1.plotly_chart(fig1, use_container_width=True, title='Quantidade de livros por ano')
col2.plotly_chart(fig2, use_container_width=True, title='Distribuição de preços dos livros')
